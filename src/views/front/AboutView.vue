    ...
    <div class="row">
      <div class="col-12 col-md-6 about-item">
        ...
        <img class="about-middleImg" src="../../assets/images/middleImg.jpg" alt="關於我們圖片">
          <p>「好咖」的故事始於一群對咖啡充滿熱情的夥伴們，<br>他們分享著相同的信念：
          <br>每一杯咖啡都是一種藝術，<br>每一次沖煮都是一次探索。
          <br>這群咖啡愛好者匯聚在一起，<br>希望將他們對於咖啡的熱情和品味帶給更多的人。</p>
      </div>
      <div class="col-12 col-md-6 about-item">
      ...
      <div class="col-12 col-md-6 about-item ">
        <p>我們將咖啡視為一種藝術形式，<br>每一杯都是由經驗豐富的咖啡師用心調製的藝術品。
          <br>品味「好咖」，感受咖啡的多重層次。</p>
        <p>我們注重可持續發展，<br>並致力於與來自各地的咖啡豆生產商建立合作關係。
          <br>這不僅保證了我們的咖啡豆的品質，<br>還有助於支持農民和維護環境。</p>
      </div>
    </div>
  </div>

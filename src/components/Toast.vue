  ...
  <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" ref="toast">
    <div class="toast-header">
      <span :class="`bg-${msg.style}`" class="p-2 rounded me-2 d-inline-block">
        <i v-if="msg.style === 'danger'" class="bi bi-x" style="color: white;"></i>
        <i v-else class="bi bi-check" style="color: white;"></i>
      </span>
...
<script>
import ToastComponent from 'bootstrap/js/dist/toast'
